...
* [X] Java 8 Lambda
* [X] Used my own library [pop](https://github.com/00ec454/pop) for tweet model(popup)

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/cakqqbC.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
